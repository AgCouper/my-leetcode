...
class Solution {   
    /**
     * NOTE: Not my solution, copy paste from leetcode.
     *  
     ...
     * to store the maximum area obtained till now. At every step, we find out 
     * the area formed between them, update maxarea  and move the pointer pointing 
